...
const About = () => {
    return (
        <div className='p-5'>
            <img className='w-25 rounded-pill border border-5 mx-auto d-block m-5' src={profile} alt="" />
            <h2 className='text-center'>Md. Nafish Sadik</h2>
            <p className='mx-auto text-center w-50'>I've had a keen interest in computers and programming since my undergraduate days.
            ...
            <p className='text-center mx-auto fw-bold text-secondary w-50'>
